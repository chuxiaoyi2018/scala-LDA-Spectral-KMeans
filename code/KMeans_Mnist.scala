...
object Mnist {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val train_path = sc.textFile("E:/App/IDEA/workplace/ml/src/data/save_train_1000.txt")
      .filter(_.nonEmpty).map(_.split(" ").map(_.toDouble)).map(Vectors.dense)
    val test_path = sc.textFile("E:/App/IDEA/workplace/ml/src/data/save_test_1000.txt")
    val real_label = sc.textFile("E:/App/IDEA/workplace/ml/src/data/test_label_1000.txt")
